...
var header = {
  sticky: function sticky() {
    var $ = document.querySelector('header.header#header');
    if (!$) return false;
    var height = getOffsetHeight($) / 2;
...
var reviews = {
  ...
  slider: function slider(element, options) {
    return new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](element, this.config(options));
  },
  init: function init() {
    var elements = document.querySelectorAll("".concat(this.selectors.el, " ").concat(this.selectors.slider));
    ...
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        ...
        var slider = this.slider(element, options);
      }
    } catch (err) {
      _iterator2.e(err);
    } finally {
...
/******/ 	__webpack_require__.O(undefined, ["css/app","css/swiper.min"], () => (__webpack_require__("./resources/js/app.js")))
/******/ 	__webpack_require__.O(undefined, ["css/app","css/swiper.min"], () => (__webpack_require__("./resources/css/app.scss")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/app","css/swiper.min"], () => (__webpack_require__("./resources/css/swiper.min.css")))
